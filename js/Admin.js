class Admin{
    ...
    hideElements() {
      ...
      setElementPosition() {
        this.generateSecretWord.position(width / 2, height / 2 - 100);
        ...
        this.backButton.position(width/2,height /2-50);
      }
      ...
      makeId(length){
        var result = "";
        var characters = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz123456780";
